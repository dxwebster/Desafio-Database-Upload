...
var ImportTransactionsService = /** @class */ (function () {
    ...
    ImportTransactionsService.prototype.execute = function (filePath) {
        return __awaiter(this, void 0, void 0, function () {
            var transactionRepository, categoryRepository, contactsReadStream, parsers, parseCSV, transactions, categories, existentCategories, existentCategoriesTitles, addCategoryTitles, newCategories, finalCategories, createdTransactions;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        newCategories = categoryRepository.create(addCategoryTitles.map(function (title) { return ({
                            title: title,
                        }); }));
